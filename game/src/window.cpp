...
void Window::_deinitialize_system() { SDL_Quit(); }
...
const std::string &Window::title() const { return _title; }

int Window::width() const noexcept { return _width; }

int Window::height() const noexcept { return _height; }
